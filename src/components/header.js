...
export default function Header() {
  ...
  return (
    <div className="container mx-auto w-full bg-auto font-sans bg-bottom bg-no-repeat" style={{ backgroundImage: `url(https://www.calstatelausu.org/_assets/Department%20Cover%20Image/special-pages-cover/about.png)`, height: '500px'}} >
      <nav className="container mx-auto relative flex lg:flex-row items-center justify-between px-2 py-3 mb-5 align-top"
        role="navigation"
      >
        <div className="flex items-center bg-black lg:flex-row rounded-xl h-12 shadow-md">
          <div className="flex relative px-3 pr-4 whitespace-nowrap">
            <Link to="/" className="hover:text-yellow-400">
              <svg className="inline pb-1 w-6 h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 14l9-5-9-5-9 5 9 5z" /><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" /></svg>
              <h1 className="nav-item inline px-1 text-base font-extrabold text-yellow-400">
                Student Union
              </h1>
            </Link>
          ...
          <div className={"text-white md:block md:flex-row flex-grow items-center m-auto px-2 justify-between font-medium" + (hamburgerOpen ? " flex flex-col rounded-xl" : " hidden")}>
        ...
        <div>
          <Link to="/contact/">
            <span className="flex">
              ...
              <span className="font-extrabold text-black px-3">
                Contact Us
              </span>
            </span>
          </Link>
